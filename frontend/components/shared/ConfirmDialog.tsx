      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-sm rounded-xl bg-card p-6 shadow-2xl dark:bg-card-dark"
          >
            <h3 className="text-base font-semibold text-text-primary dark:text-text-primary-dark">{title}</h3>
